  ...
  return (
    <header className="w-full flex items-center justify-between px-4 py-2 bg-gray-50 shadow-md">
      ...
      <div className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-1">
        ...
        <span className="text-xl font-bold text-gray-800 -ml-1">lphabridge</span>
      </div>
      {/* Center: Navigation */}
      <nav className="flex gap-2">
        <a href="/" className="flex items-center gap-1 text-gray-700 hover:text-blue-600 font-medium transition rounded-full shadow-md border border-gray-300 hover:border-blue-500 px-3 py-1.5 bg-white hover:bg-blue-50 active:bg-blue-600 active:text-white focus:bg-blue-600 focus:text-white text-sm">
          <FaHouseChimney className="w-4 h-4" />
          Home
        </a>
        <a href="/schedule" className="flex items-center gap-1 text-gray-700 hover:text-blue-600 font-medium transition rounded-full shadow-md border border-gray-300 hover:border-blue-500 px-3 py-1.5 bg-white hover:bg-blue-50 active:bg-blue-600 active:text-white focus:bg-blue-600 focus:text-white text-sm">
